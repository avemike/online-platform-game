...
// import all sprites
const run_right = importAll(
  require.context("./imgs/run_right", false, /\.(png)$/)
);
const run_left = importAll(
  require.context("./imgs/run_left", false, /\.(png)$/)
);
const idle_right = importAll(
  require.context("./imgs/idle_right", false, /\.(png)$/)
);
const idle_left = importAll(
  require.context("./imgs/idle_left", false, /\.(png)$/)
);
const jump_right = importAll(
  require.context("./imgs/jump_right", false, /\.(png)$/)
);
const fall_right = importAll(
  require.context("./imgs/fall_right", false, /\.(png)$/)
);
const jump_left = importAll(
  require.context("./imgs/jump_left", false, /\.(png)$/)
);
const fall_left = importAll(
  require.context("./imgs/fall_left", false, /\.(png)$/)
);

// assign sprites to arrays of Image objects as an sources
