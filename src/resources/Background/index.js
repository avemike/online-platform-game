...
import { SprTreesInBgLast, SprTreesInBgFirst, TreesInBgFirstWidth } from './Trees/SprTreesInBg';
...
for (let i = 0; i < rowNumber; i++) {
  TreesInBg.push(
    new ObjTreesInBgFirst( SprTreesInBgFirst, {x: -400 + TreesInBgFirstWidth * i, y: treesInBgY + 70})
  )
}
